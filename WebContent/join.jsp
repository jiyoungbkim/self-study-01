...
<form name="form" method="post" action="JoinServlet">
    ...
    <label for="socialnumber"> 주민등록번호 </label><span style="color:red;"> * </span>
    <input type="text" id="s_num1" name="s_num1"> -
    <input type="text" id="s_num2" name="s_num2"> <br>
    ...
    <input type="text" id="email_dns" name="email2">
